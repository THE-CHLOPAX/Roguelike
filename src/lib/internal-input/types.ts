...
export type GamepadInput = {
    ...
    addAxisMoveListener: (axis: GamepadAxisName | number, callback: (value: number) => void, once?: boolean) => () => void;
    ...
    removeAxisMoveListener: (axis: GamepadAxisName | number, callback: (value: number) => void) => void;
    removeAllListeners: () => void;
    disable: () => void;
    enable: () => void;
}
